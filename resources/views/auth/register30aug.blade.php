        ...
        <div class="signup">    
          ...
          <div class="signleft-customer">
           ...
           <span class="error" id="b_profile"></span>
             ...
             <input type="text" name="lastname" id="b_lastname" size="30" maxlength="80" placeholder="Last Name">
             <span class="error" id="b_ln"></span>
             
              <div class="row col-sm-12 text-left">
             <label>User Name <span class="color-red">*</span></label>
             </div>
             <input type="text" name="username" id="b_username" size="30" maxlength="80" placeholder="User Name">
             <span class="error" id="b_un"></span>
    ...
    if($("#b_firstname").val()!=''){
        if($("#b_lastname").val()!=''){
            if($'#b_username').val()!=''{
                ...
                $('#b_un').text("Please Enter username");
            }
            }else{
...
var posturl = '/auth/registerBusiness';
 ...
 formdata.append('username',$("#b_username").val())
