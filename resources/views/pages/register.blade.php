        ...
        <div class="signup">    
          ...
          <div class="signleft-customer">
            ...
            <form id="frmregister" method="post">
             ...
             <input type="text" name="username" id="c_username" size="30" maxlength="80" placeholder="User Name">
             <span class="error" id="c_username"></span>
    ...
    if($("#c_firstname").val()!=''){
        if($("#c_lastname").val()!=''){
            if($("#c_username").val()!=''){
                if($("#c_email").val()!=''){
                    if($("#c_contact").val()!=''){
                            if(($("#c_password").val()!='')&& $("#c_password").val().length >=8){
                                ...
                                $("#c_pass").text("Please Enter the Password, more the 8 character");   
                            }
                    }else{
             ...
             $("#c_username").text("Please Enter the Username ");
           } else{
                ...
                if($("#b_email").val()!=''){
                    if($("#b_contact").val()!=''){
                            if($("#b_password").val()!=''){
                                ...
                                $("#b_pass").text("Please Enter the ");   
                            }
                    }else{
                        $("#b_cot").text("Please Enter the ");
                    }
                }else{
                    $("#b_eml").text("Please Enter the ");
                }
            }else{
    $("#b_ln").text("Please Enter the ");
            }
    
    }else{
    $("#b_fn").text("Please Enter the ");
    }
    });
                    ...
                    if($("#b_city").val()!=''){
                        if($("#b_zipcode").val()!=''){
                            if($("#b_country").val()!=''){
                                ...
                                $("#b_cont").text("Please Enter the ");
                            }
                        }else{
                            $("#b_zip").text("Please Enter the ");
                        }
                    }else{
                        $("#b_ct").text("Please Enter the ");
                    }
                }else{
                    $("#b_sta").text("Please Enter the ");
                }
            }else{
    $("#b_addr").text("Please Enter the ");
            }
    
    }else{
    $("#b_cmpo").text("Please Enter the ");
    }
    });
   ...
   $("#b_submit").click(function(){
    ...
    if($("#b_EINnumber").val()!=''){
        if($('#b_Establishmentyear').val()!=""){
            ...
            $("#b_estb").text("Please Enter the ");
        }
    }else{
        $("#b_ein").text("Please Enter the ");
    }
                ...
                if($("#p_email").val()!=''){
                    if($("#p_contact").val()!=''){
                            if($("#p_password").val()!=''){
                                ...
                                $("#p_pass").text("Please Enter the ");   
                            }
                    }else{
                        $("#p_cot").text("Please Enter the ");
                    }
                }else{
                    $("#p_eml").text("Please Enter the ");
                }
            }else{
    $("#p_ln").text("Please Enter the ");
            }
    
    }else{
    $("#p_fn").text("Please Enter the ");
    }
    });
                    ...
                    if($("#p_city").val()!=''){
                        if($("#p_zipcode").val()!=''){
                            if($("#p_country").val()!=''){
                                ...
                                $("#p_cont").text("Please Enter the ");
                            }
                        }else{
                            $("#p_zip").text("Please Enter the ");
                        }
                    }else{
                        $("#p_ct").text("Please Enter the ");
                    }
                }else{
                    $("#p_sta").text("Please Enter the ");
                }
            }else{
    $("#p_addr").text("Please Enter the ");
            }
    
    }else{
    $("#p_cmpo").text("Please Enter the ");
    }
    });
   ...
   $("#p_submit").click(function(){
    ...
    if($("#p_EINnumber").val()!=''){
        ...
        if($('#p_Establishmentyear').val()!=""){
            ...
            $("#p_estb").text("Please Enter the ");
        }
        }else{
            $("#p_ssn").text("Please Enter the ");
        }
    }else{
        $("#p_ein").text("Please Enter the ");
    }
