                    ...
                    <?php
                        ...
                        foreach ($_SESSION["cart_item"] as $item){
                            ...
                            if (File::exists(public_path("/uploads/profile_pic/thumb/" . $item['image']))) {
                                $profilePic = url('uploads/profile_pic/thumb/' . $item['image']);
                            } else {
                                    ...
                                    <div class="kickboxing-block1">
                                        <div class="topimg-content">
                                            ...
                                            if (File::exists(public_path("uploads/profile_pic/thumb/" . $service['profile_pic']))) {
                                                $profilePic = url('uploads/profile_pic/thumb/' . $service['profile_pic']);
                                            } else {
                                                $profilePic = 'images/default-avatar.png';
                                            }
                                            ?>
                                        ...
                                        if (File::exists(public_path("uploads/profile_pic/thumb/" . $companylogo))) {
                                            $companyLogo = url('uploads/profile_pic/thumb/' . $companylogo);
                                        } else {
                                            $companyLogo = 'images/default-avatar.png';
                                        }
                                        ?>
                                        <div class="bottom-content">
                                            <div class="ratset-img">
                                                ...
                                                <div class="verifiedimg"><img src="images/verified-logo.png"></div>
                                            </div>
                                            <h3><?= $service['program_name'] ?></h3>
                                            <h6><?= $companyname ?></h6>
                                            <p><?= $companyaddress ?></p>
                                            <h5><?= $service['sport_activity'] ?> <img src="{{ url('img/arrow-down.png') }}"></h5>
                                            <hr>
