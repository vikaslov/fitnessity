...
@section('content')
    ...
    <p>
        ...
        <a href="{!! route('create-new-person') !!}" class="btn btn-success">Add New</a>
    ...
    <div class="panel panel-default">
        ...
        {!! Form::open(array('route' => 'delete-plans', 'id' => 'planlist')) !!}
            ...
            <div class="table-responsive">
              <table id="online_list" class="table table-bordered table-striped {{ count($persons) > 0 ? 'datatable' : '' }} table-hover ">
                ...
                <tbody>
                        ...
                        @foreach ($persons as $value)
                          ...
                          <?php $i++ ?>
                            ...
                            <tr id="item-{!! $value->id !!}">
                                ...
                                <td><input type="checkbox" name="personIds[]" value="{{$value->id}}"></td>

                                <td><img src="{{ asset('public/uploads/person/thumb/'.$value->image) }}" width="150" height="auto" /></td>

                                <td><a href="\admin\person\edit\{{$value->id}}" title="Click to edit {{@$value->heading}}">{{@$value->heading}}</a></td>
                  ...
                  <td>
                      ...
                      <a href="\admin\person\edit\{{$value->id}}" title="Click to edit {{@$value->heading}}" class="btn btn-xs btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>

                      <a href="\admin\person\delete\{{$value->id}}" title="Click to delete {{@$value->heading}}" onclick="return confirm('Are you sure?')" class="btn btn-xs btn-primary"><i class="fa fa-trash" aria-hidden="true"></i></a>
                 ...
                 <tfoot>
                    ...
                    <button type="submit" id="submit_delete_person" name="submit_delete_person" class="btn btn-danger btn-xs" title="Deactivate Selected Plans" onclick="return confirm('Do you really want to deactivate selected Plans?');" value="1"><i class="fa fa-ban" aria-hidden="true"></i></button>
