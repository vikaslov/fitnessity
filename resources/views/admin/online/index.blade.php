...
@section('content')
    ...
    <p>
        ...
        <a href="{!! route('create-new-online') !!}" class="btn btn-success">Add New</a>
    ...
    <div class="panel panel-default">
        ...
        {!! Form::open(array('route' => 'delete-plans', 'id' => 'planlist')) !!}
            ...
            <div class="table-responsive">
              <table id="online_list" class="table table-bordered table-striped {{ count($onlines) > 0 ? 'datatable' : '' }} table-hover ">
                ...
                <tbody>
                        ...
                        @foreach ($onlines as $value)
                          ...
                          <?php $i++ ?>
                            ...
                            <tr id="item-{!! $value->id !!}">
                                ...
                                <td><img src="{{ asset('public/uploads/online/thumb/'.$value->image) }}" width="150" height="auto" /></td>

                                <td><a href="\admin\plans\edit\{{$value->id}}" title="Click to edit {{@$value->heading}}">{{@$value->heading}}</a></td>
                  ...
                  <td>
                      ...
                      <a href="\admin\online\edit\{{$value->id}}" title="Click to edit {{@$value->heading}}" class="btn btn-xs btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>

                      <a href="\admin\online\delete\{{$value->id}}" title="Click to delete {{@$value->heading}}" onclick="return confirm('Are you sure?')" class="btn btn-xs btn-primary"><i class="fa fa-trash" aria-hidden="true"></i></a>
