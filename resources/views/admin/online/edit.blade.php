...
{!! Form::open(array('id' => 'editOn','enctype' => 'multipart/form-data', 'route' => ['update-online', $onlines->id])) !!}
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="row">
            ...
            @if($onlines['image'] != '' && file_exists(public_path().DIRECTORY_SEPARATOR.'uploads'.DIRECTORY_SEPARATOR.'online'.DIRECTORY_SEPARATOR.'thumb'.DIRECTORY_SEPARATOR.$onlines['image']))

              <img src="{{ asset('public/uploads/online/thumb/'.$onlines->image) }}" height="100px" width="100px"/> 
          ...
          <div class="row">
            <div class="col-xs-12 form-group {{ $errors->has('heading') ? ' has-error' : '' }} ">
                ...
                {!! Form::text('heading', $onlines->heading, ['id' => 'heading', 'required' =>'required', 'class' => 'form-control', 'placeholder' => '']) !!}
          ...
          <div class="row">
            <div class="col-xs-12 form-group {{ $errors->has('duration') ? ' has-error' : '' }} ">
                ...
                {!! Form::text('duration', $onlines->duration, ['id' => 'duration', 'required' =>'required', 'class' => 'form-control', 'placeholder' => '']) !!}
                <p class="help-block"></p>
          ...
          <div class="row">
            <div class="col-xs-12 form-group {{ $errors->has('level') ? ' has-error' : '' }} ">
                ...
                {!! Form::text('level', $onlines->level, ['id' => 'level', 'required' =>'required', 'class' => 'form-control', 'placeholder' => '']) !!}
                <p class="help-block"></p>
                    @if($errors->has('level'))
                        <p class="help-block">
                            {{ $errors->first('level') }}
           ...
           <div class="row">
            <div class="col-xs-12 form-group {{ $errors->has('timings') ? ' has-error' : '' }} ">
                ...
                {!! Form::text('timings', $onlines->timings, ['id' => 'timings', 'required' =>'required', 'class' => 'form-control', 'placeholder' => '']) !!}
                <p class="help-block"></p>
          ...
          <div class="row">
            <div class="col-xs-12 form-group {{ $errors->has('price') ? ' has-error' : '' }} ">
                ...
                {!! Form::text('price', $onlines->price, ['id' => 'price', 'required' =>'required', 'class' => 'form-control', 'placeholder' => '']) !!}
                <p class="help-block"></p>
                    @if($errors->has('price'))
                        <p class="help-block">
                            {{ $errors->first('price') }}
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <input type="hidden" name="id" id="id" value="{{$onlines->id}}">         
               ...
               <a href="\admin\online" class="btn btn-danger ">Cancel</a>
              </div>
            </div>
          </div>
