...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panel_manage_professionals">
                    ...
                    @if (count($professionals) > 0)
                        ...
                        @foreach ($professionals as $value)
                            ...
                            <tr id="item-{!! $value->id !!}">
                                ...
                                <td><a href="\admin\professionals\view\{{$value->id}}" title="Click to view{{@$value->title}}">{{ $value->firstname . " ". $value->lastname}}</a></td>
                                ...
                                <a href="\admin\professionals\view\{{$value->id}}" title="Click to view user profile" class="btn btn-xs btn-info"><i class="fa fa-eye" aria-hidden="true"></i></a>
