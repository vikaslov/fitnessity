...
@section('content')
         ...
         <div class="panel panel-default">
            ...
            List
                <div class="col-md-6 pull-right"><a href="{{route('background_check_faq')}}" class="btn btn-xs btn-info pull-right"><i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i></a></div>
            </div>
             <div class="panel-body">
                   {!! Form::open(array('url' => route('background_check_faq_update'))) !!}
