                        ...
                        <a href="/viewBooking/{{ $job->id }}" title="Click here to view more" class="readmore">
                          ...
                          <div class="review-rate-block">
                              ...
                              @if($job['status'] == "confirmed")
                                <span class="booking-booked-text">Booked
                              @elseif($job['business_id'] != null && $job['status'] == "requested")
                                <span class="booking-pending-text">Confirmation Pending
                              @elseif($job['business_id'] == null && $job['status'] == "requested")
                                <span class="boking-openall-text"> Open to All
                              @elseif($job['status'] == "rejected")
                                <span class="booking-rejected-text"> Rejected
                              @endif
                              <br><a>{{ $job['businessuser']['firstname'] }} {{ $job['businessuser']['lastname'] }}</a>
                              </span>
                          </div>
