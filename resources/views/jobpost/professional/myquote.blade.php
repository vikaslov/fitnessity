                    ...
                    <div class="review-detail job-list-div">
                        <!-- <a href="/viewBoking/{{ $job->id }}" title="Click here to view more"> -->
                          ...
                          <div class="review-rate-block">
                              @if($job->status == "requested" && $job->business_id == Auth::user()->id)
                                <?php $url = "/viewBooking/".$job->id; ?>
                              @else
                                <?php $url = "/booking/postquote/".$job->id; ?>
                              @endif
                              <a href="{{ $url }}" title="Click here to view more" class="readmore">
                              ...
                              @else
                              <br>
                              <span class="booking-rejected-text"><a href="/viewBooking/{{ $job->id }}" class="readmore">View Quote</a></span>
                              @endif                             
                          </div>
                      ...
                      <div class="job_post_dtls">
                          ...
                          <p>Rate Type: {{ ucfirst($job['rate_type']) }} <br><br>
