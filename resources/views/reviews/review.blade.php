        ...
        <div class="review-dtl-block">
                ...
                <div class="row">
                  <div class="col-lg-2 col-md-2 col-sm-7 col-xs-12">
                    <span class="review-user">
                      ...
                      //print_r($reviewByUser->profile_pic);
                      //exit;
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                    <div class="review-detail">
                      ...
                      <div class="review-rate-block">
                        ...
                        <span class="fontt14"><?php echo date('j<\s\up>S</\s\up> M Y', strtotime($review->created_at)); ?>
                        </span>
                      </div>
          ...
          <div class="review-list-block">
            <div class="row">
              <div class="col-lg-2 col-md-2 col-sm-7 col-xs-12">
                <span class="review-user">
                  <img src="{{ Config::get('constants.FRONT_IMAGE').'user.png' }}" alt="" width="352" height="314">
                </span>
              </div>
              <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
                <div class="review-detail">
