...
<div id="mayankstep1">
                ...
                <div class="emplouyee-form hrsam">
                    ...
                    <input type="number" name="frm_serviceprice" id="frm_serviceprice" value="{{str_replace('$','',$service['price'])}}" placeholder="Price($)" title="serviceprice" style="margin-top: 15px;">
                    @else
                    <input type="number" name="frm_serviceprice" id="frm_serviceprice" placeholder="Price($)" title="serviceprice" style="margin-top: 15px;">
                    @endif
         ...
         <?php //print_r($key);die; ?>
          <div class="day-time-div">
              ...
              <div class="form-control thrusday_start" @if($value->thrusday_start !='') style="margin-top:10px;" @else style="display:none;margin-top:10px;" @endif>
                  <div class="row">
                    <label class="col-md-12">Thrusday Time</label><br/>
                    <div class="col-md-5" >
                        @if($key == 0)
          ...
          <div class="wrapperow">
              ...
              <div class="form-control thrusday_start" style="display:none;margin-top:10px;">
                  <div class="row">
                    <label class="col-md-12">Thrusday Time</label><br/>
                    <div class="col-md-5" >
                        <input type="text"  class="thruquicktimepicker" name="hours[thrusday_start]" value="{{$hours['thrusday_start']}}" autocomplete="off" style=" width:100%">
                    </div>
                    <div class="col-sm-1"> &nbsp;-&nbsp;</div>
                    <div class="col-md-5" >   
    ...
    <div >
            ...
            <div class="modallink mt20">
              <div class="signup-new-customer text-center">
                  ...
                  <button type="button" class="stepbtn" href="#" onclick="$('#mayankstep1').hide();$('#mayankstep2').hide();$('#mayankstep3').show();">NEXT</button>
              </div>
          </div>
</div>
<br>
...
"Specific date"=>"Specific date");
                  ...
                  <p style="text-align: initial;padding-left: 17px;">Select the section you require your clients to agree to upon completing registration.</p>
                    ...
                    <p id="termcondfaqtexterror" class="error"></p>
                  </div>
                  <div class="row hrsam term-wrpp">
                    <div class="col-md-3">
                        <div class="col-md-12 qh-steps-form samm">
                    ...
                    <p id="contracttermstexterror" class="error"></p>
                  </div>
                  <div class="row hrsam term-wrpp">
                    <div class="col-md-3">
                        <div class="col-md-12 qh-steps-form samm">
                    ...
                    <p id="liabilitytexterror" class="error"></p>
                  </div>
                    <div>
                      <span class="step"></span>
                      <span class="step"></span>
                     ...
                     <div class="modallink mt20">
                      <div class="signup-new-customer text-center">
                      	...
                      	<button type="button" class="stepbtn" href="#" onclick="$('#mayankstep1').hide();$('#mayankstep2').show();$('#mayankstep3').hide();">PREVIOUS</button>
...
<script>
  //$(document).ready(function() {
     ...
     formdata.append('frm_profile_pic',add_service_var)
     if($('#frm_servicesport').val() != '' ){
         formdata.append('frm_servicesport',$('#frm_servicesport').val())
         if($('#frm_servicetitle').val() != ''){
             formdata.append('frm_servicetitle',$('#frm_servicetitle').val())
            if($('#frm_servicetimeslotfrom').val() != ''){
                formdata.append('frm_servicetimeslotfrom',$('input[name="frm_servicetimeslotfrom"]').val())
                if($('#frm_servicetimeslotto').val() != ''){
                    formdata.append('frm_servicetimeslotto',$('input[name="frm_servicetimeslotto"]').val())
                    if($('#frm_serviceprice').val() != '' && $('#frm_serviceprice').val() != '$'){
                        formdata.append('frm_serviceprice',$('#frm_serviceprice').val())
                        if($('#frm_servicedesc').val() != ''){
                            formdata.append('frm_servicedesc',$('#frm_servicedesc').val())
                            $('#service_new').text('Tell us more about your services');
                            $('#mayankstep1').hide();$('#mayankstep2').show();$('#mayankstep3').hide();
                        }
                        else{
      ...
      $('#startingpicker').Zebra_DatePicker({
        ...
        onSelect: function() { 
            var day = moment($(this).context.value,'YYYY-MM-DD').format('dddd')
            var new_date = moment($('#startingpicker').val(),"YYYY-MM-DD").add($('#frm_schedule_until').val().split(' ')[0],'M').format('YYYY-MM-DD')
...
setTimeout(function(){
    ...
    $("#startingpicker").val("{{$service['starting_date']}}").data('Zebra_DatePicker').show();
},1000)
...
$('.day-time-div-main .sunquicktimepicker').timepicker({
        ...
        });$('.day-time-div-main .thruquicktimepicker').timepicker({
            timeFormat: 'h:mm p',
            interval: 30, 
            startTime: '00:00',
            dynamic: true,
...
arr2.forEach(function(value,key){
    if(key!=0){
        ...
        });$('.day-time-div-main .thruquicktimepicker'+(key+1)).timepicker({
            timeFormat: 'h:mm p',
            interval: 30, 
            startTime: '00:00',
            dynamic: true,
  ...
  i= i+1
   // console.log("iii "+i)
    ...
    setTimeout(function(){
        ...
        });$('.day-time-div-main .thruquicktimepicker'+i).timepicker({
            timeFormat: 'h:mm p',
            interval: 30, 
            startTime: '00:00',
            dynamic: true,
...
function myDayFunction(){
    console.log("run2")
    var day = moment($('#starting_picker'),'YYYY-MM-DD').format('dddd')
            if($('#frm_class_meets').val() != 'Weekly'){
                if(day == 'Monday'){
                    $(".Monday").show()
                    $(".Sunday").hide()
...
$('#frm_class_meets').change(function(){
    ...
    if($("#frm_class_meets").val() == 'Weekly'){
        ...
        $(".schedule_until_box").hide()
         if($("#startingpicker").val() != ''){
             var day = moment($("#startingpicker").val(),'YYYY-MM-DD').format('dddd')
            if(day == 'Monday'){
                    $(".Monday").show()
                    $(".Sunday").hide()
                    $(".Tuesday").hide()
...
<script>
  ...
  $('#servicedata').submit(function(e) {
        ...
        setTimeout(function(){
            ...
            inputData.append('class_meets',$('#frm_class_meets').val())
            inputData.append('starting_date',$('#startingpicker').val())
        ...
        if($("#termcondfaqtext").val() != ''){
            $("#termcondfaqtexterror").text('')
            if($("#contracttermstext").val() != ''){
                $("#contracttermstexterror").text('')
                if($("#liabilitytext").val() != ''){
