            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row">
                     ...
                     <input type="text" style="width:100%" class="frm_starting frm_starting1" name="starting" placeholder="Starting" id="startingpicker" autocomplete="off">
                     </div>
                     </div>
                </div>
                    ...
                    <div id="setnumbermsg" style="display:none"></div>
                      ...
                      <label>Duration</label>
                            <select name="expire_in_option" class="form-control" >
                                ...
                                <option @if($service['expire_in_option'] == 'Months') selected @endif value="Months">Months</option>
                        ...
                        <div class="col-md-3 often">
                             <select name="often_every_op2" class="form-control" id="select_box_month">
                                 <option  @if($service['often_every_op2'] == 'Week') selected @endif value="Week">Week</option>
                                  <option  @if($service['often_every_op2'] == 'Months') selected @endif value="Months">Months</option>
